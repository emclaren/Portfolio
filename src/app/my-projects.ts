...
{ id: 1, 
  ...
  overview: 'Mind-Full is an EEG-neurofeedback system that allows children (ages 6-10) to practice self-regulating their emotional state. ',
  team: 'Alissa N. Antle, Perry Tan, Srilekha Kirsh Sridharan, Fan Lin, Emily Cramer',
  tags: 'NeuroSky Mindwave Mobile headset, Unity Game Engine, Android OS,',
  role: 'Developer, Tester, Project Manager, Researcher – see below for further details.',
  ...
  pImage1Class:'col-xs-12 col-sm-4 col-lg-6 ',
  pImage2Class:'none',
  pImage3Class:'col-xs-12 col-sm-4 col-lg-6 ',
  ...
  pImage4Class:'col-xs-12 col-sm-4 col-lg-6',
  pImage5Class:'col-xs-12 col-sm-4 col-lg-6',
  pImage6Class:'none',
  ...
  rImage1Class:'col-xs-12 col-sm-4 col-lg-6',
  rImage2Class:'none',
  rImage3Class:'col-xs-12 col-sm-4 col-lg-6',
...
{ id: 2, 
  ...
  rImage1Class:'col-xs-12 col-sm-6 col-lg-6 ',
  rImage2Class:'col-xs-12 col-sm-6 col-lg-6 ',
  rImage3Class:'none ',
