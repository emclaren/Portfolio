...
{ id: 1, 
  ...
  cImage2Class: 'none',
  cImage3Class: 'none',
  pImage1:'assets/img/mind-fullimg.png',
  pImage2:'assets/img/squirrel.png',
  pImage3:'assets/img/bear.png',
  pImage1Class:'col-xs-12 col-sm-4 col-lg-4 ',
  pImage2Class:'col-xs-12 col-sm-4 col-lg-4 ',
  pImage3Class:'col-xs-12 col-sm-4 col-lg-4 ',
  pImage4:'assets/img/mind-full.jpg',
  pImage5:'assets/img/IMG_5145.JPG',
  pImage6:'assets/img/mind-full-thumbnail-min.jpg',
  pImage4Class:'col-xs-12 col-sm-4 col-lg-6 ',
  pImage5Class:'col-xs-12 col-sm-4 col-lg-6 ',
  pImage6Class:'col-xs-12 col-sm-4 col-lg-6',
  rImage1Class:'none',
  rImage2Class:'none',
  rImage3Class:'none',
  rImage4:'assets/img/brainhack.jpg',
  rImage5:'',
  rImage6:'',
...
challengeHeading:'Improving and adapting an existing tool for new users.',
  ...
  r2:'',
  r3:'',
  cImage1: 'assets/img/block-talks.jpg',
  cImage2: 'assets/img/example.jpg',
  cImage3: 'assets/img/block-talk-prototype.jpg',
  cImage1Class: 'col-xs-12 col-sm-6 col-lg-4 ',
  cImage2Class: 'col-xs-12 col-sm-6 col-lg-4 ',
  cImage3Class: 'col-xs-12 col-sm-6 col-lg-4 ',
  pImage1:'assets/img/blocktalks.jpg',
