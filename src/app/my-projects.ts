...
{ id: 1, 
  ...
  resultHeading2:'',
  resultHeading3:'Neurofeedback for youth',
  ...
  cImage2:'assets/img/mindfull/mind-full-squirrel-min.png',
  cImage3: 'assets/img/mindfull/mind-full-splash-min.png',
  cImage1Class: 'none',
  cImage2Class: 'none',
  cImage3Class: 'none',
  pImage1:'assets/img/mindfull/mind-full-brainstorm-min.jpg',
  pImage2:'assets/img/mindfull/mind-full-bugs-min.jpg',
  pImage3:'assets/img/mindfull/mind-full-unity-min.png',
  pImage1Class:'none',
  pImage2Class:'none',
  pImage3Class:'none',
  pImage4:'assets/img/mindfull/mind-full-pair-min.jpg',
  pImage5:'assets/img/mindfull/mind-full-study-min.JPG',
  pImage6:'assets/img/mindfull/mindfull-testing-min.png',
  pImage4Class:'none',
  pImage5Class:'none',
  pImage6Class:'none',
  rImage1:'assets/img/mindfull/mind-full-sfn-poster-min.jpg',
  rImage2:'assets/img/mindfull/mind-full-headphones-min.jpg',
  rImage3:'assets/img/mindfull/mind-full-codesign-min.jpg',
  rImage1Class:'none',
  rImage2Class:'none',
  rImage3Class:'none',
...
{ id: 2, 
  ...
  r2:'',
  r3:'',
  cImage1: 'assets/img/blocktalks/block-talks-logo-min.jpg',
  cImage2: 'assets/img/blocktalks/block-talks-scan-min.jpg',
  cImage3: 'assets/img/blocktalks/block-talks-logo-min.jpg',
  cImage1Class: 'none',
  cImage2Class: 'none',
  cImage3Class: 'none ',
  pImage1:'assets/img/blocktalks/block-talk-prototype-min.jpg',
  pImage2:'assets/img/blocktalks/block-talks-blocks-min.jpg',
  pImage3: 'assets/img/blocktalks/block-talks-ar-demo-min.png',
  pImage1Class:'none ',
  pImage2Class:'col-xs-12 col-sm-6 col-lg-6 ',
  pImage3Class:'col-xs-12 col-sm-6 col-lg-6 ',
  pImage4:'',
  pImage5:'',
  pImage6:'',
  pImage4Class:'none ',
...
{ id: 3, 
  ...
  cImage1: 'assets/img/audiomatic/audio-matic-thumbnail-min.jpg',
  cImage2: 'assets/img/audiomatic/magenta-screen.jpg',
  cImage3: 'assets/img/audiomatic.png',
  cImage1Class: 'none ',
  cImage2Class: 'none',
  cImage3Class: 'none ',
  ...
  pImage1:'assets/img/audiomatic/single-gif.gif',
  pImage2:'assets/img/audiomatic/audiomaticgif.gif',
  pImage3: 'assets/img/audiomatic/audiomatic.gif',
  pImage1Class:'none ',
  pImage2Class:'none ',
  pImage3Class:'none',
  pImage4:'',
...
{ id: 4, 
  ...
  cvideo:'none',
  cvideoClass:'none',
  cImage1: 'assets/img/tangibles/johnny-five-min.jpg',
  cImage2: 'assets/img/tangibles/rockcamp2.png',
  cImage3: 'assets/img/tangibles/girlsrock8-min.jpg',
  cImage1Class: 'none',
  cImage2Class: 'none ',
  cImage3Class: 'none',
  ...
  pImage1:'assets/img/tangibles/johnny-five-min.jpg',
  pImage2:'assets/img/tangibles/arduino-node.jpg',
  pImage3: 'assets/img/tangibles/arduino.jpg',
  pImage1Class:'col-xs-12 col-sm-6 col-lg-6 ',
  pImage2Class:'col-xs-12 col-sm-6 col-lg-6 ',
  pImage3Class:'none ',
...
{ id: 5, 
 ...
 cvideo:'none',
  cvideoClass:'none',
 cImage1: 'assets/img/earthgazement/earthgazing-thumbnail-min.jpg',
  cImage2: 'assets/img/earthgazement/earth-sky.jpg',
  cImage3: 'assets/img/earthgazement/earthgazement3-min.png',
  cImage1Class: 'col-xs-12 col-sm-6 col-lg-6 ',
  cImage2Class: 'none ',
  cImage3Class: 'col-xs-12 col-sm-6 col-lg-6 ',
  challengeHeading:'';
  ...
  pImage1:'assets/img/earthgazement/earth.jpg ',
  pImage2:'',
  pImage3: '',
  pImage1Class:'col-xs-12 col-sm-6 col-lg-6 ',
  pImage2Class:'none ',
...
cvideo:'none',
  ...
  cImage1: 'assets/img/asking/asking-for-a-friend-thumbnail-min.jpg',
  cImage2: 'assets/img/asking/asking-notepad.jpg',
  cImage3: '',
  c1:'Youth depression and suicide is on the rise.  Many young people experience barreirs to seeking help. These include absence of a confidante, shame/fear/stigma, and lack of available resources. Asking For a Friend is a chatbot designed to direct individuals experiencing mentalh health challenges to nearby, in-person and phone resources. We leveraged existing technology and social media resources to eradicate the fear of initial in-perosn interaction, and the lack of accessibility to resources to help the lives of youth, and help mental health support organizations fulfill their mandate. ',
  cImage1Class: 'col-xs-12 col-sm-6 col-lg-6 ',
  cImage2Class: 'none',
  cImage3Class: 'none ',
  pImage1:'assets/img/asking/asking-ideation-min.jpg', 
  pImage2:'assets/img/asking/lumohacks-min.jpg',
  pImage3: 'assets/img/asking/asking-screen.jpg',
  pImage1Class:'none',
  pImage2Class:'none ',
  pImage3Class:'none',
  problemHeading1:'',
