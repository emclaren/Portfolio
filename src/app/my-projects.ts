...
{id: 2, 
  ...
  summary:'An interactive web video' ,
  ...
  problemHeading1:'',
  problemHeading2:'',
  p1:'For this project, I updated the content on hello.p5js.org. The final project is still under review, and will be launched in October. The project involved first, doing qualitative surveys to find out what the community likes about p5js, and why they use it. Next, I developed storyboards for the video, and gathered feedback from p5\'s core team. Next I recruited volunteers, and collected video content from them. I started from scratch, developing new wireframes and interactivty. I edited the video using Adobe Premiere, After Effects, and Audition. The website uses P5.js, and NodeJS. Multi-lingual captions were added to increase accessibility',
  p2:'',
  p3:' ',
  p4:'',
  p5:'',
  ...
  resultHeading1: '',
  resultHeading2: '',
  r1:'As the individuals viewing the site may be brand new to coding, it is important that this webpage be inviting, interesting and informative. Further, it must be accessible and work properly across devices. I am currently conducting testing to ensure cross-browser compatability',
  r2:' ',
  r3:'',
  caption7:'',
 url:"",
...
{id: 3, 
  ...
  overview: 'Creating new designs using found materials',
  team: 'N/A',
  tags: 'Circuits, LED, Instructables, Paper',
  role: 'Designer, Creator',
  caption1:'Petit Prince Lamp',
  caption2:'Petit Prince Supplies',
  challengeHeading:'',
  c1:'I have an ongoing project of creating DIY paper lamps out of recycled components & paper supplies. Recently one based on the theme of the Little Prince book won honourable mention in an Instructables contest. I will describe this lamp here. ',
  c2:'',
  c3: '',
  c4: '',
...
{id: 4, 
  ...
  overview: 'Designing and creating tangible objects for collaborative decision making',
  team: 'NA',
  tags: 'NFC, Tangible Computing, Instructables',
  role: 'Designer, Creator',
