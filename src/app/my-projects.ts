...
{ id: 1, 
  ...
  summary:'A smart planter to let you know when your plant is being neglected',
  overview: 'Design and development of an Instructables first-prize winning smart planter',
  team: 'N/A',
  ...
  p2:'At a most basic level, I understood that my plant needed two things in order to survive: Water, and Light. Accordingly, Plantagotchi has a water sensor and a light sensor. If the plant does not receive light for an extended period of time, or if its water dries up, the Plantagotchi\'s eyes turn to Xs.',
  p3:'During the day, Plantagotchi\'s eyes look around the room. When it gets dark it shuts them (see video in Instructables, linked below). This gives it a little bit of personality!',
  p4:'The eyes are displayed on two mirrored TFT screens connected to a Teensy Arduino.',
  p5:'',
  caption5:'Programming the eyes',
  caption6:'Rear view of planter',
  resultHeading1: 'First-prize Winning',
  resultHeading2: '',
  r1:'Plantagotchi won first-prize in the Instructables planter competition.',
  r2:'',
  r3:'',
  caption7:'',
