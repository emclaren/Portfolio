...
{ id: 1, 
	name: 'Plantagotchi',
  thumbname: 'Plantagotchi',
  class: 'plantagotchi',
  thumbnail:'assets/img/plantagotchi/plantagotchi-thumbnail-min.jpg',
  summary:'A smart planter that lets you know when your plant is neglected',
  overview: 'Design and development of an prize-winning smart planter',
  team: 'N/A',
  tags: 'Arduino, Teensy, IOT, TFT Screens, Instructables',
  role: 'Designer, Developer',
  caption1:'A neglected plantagotchi',
  caption2:'A lively plantagotchi',
  challengeHeading:'Plantagotchi dies so your plant doesn\'t have to.',
  c1:'When I became the proud owner of a new houseplant (named Chester), I really wanted him to have a long and healthy life. Unfortunately, I do not have a green thumb. I was instantly convinced that I would send Chester to an early grave if I didn\'t get help. He was already a little sad looking when I got him.',
  c2:'This is how I came up with Plantagotchi - a smart planter that lets you know when you are being a neglectful plant parent. Plantagotchi turns your plant into a cyborg that gives feedback when its needs aren\'t met. If it doesn\'t get enough sunlight or water, it dies (its eyes turn to Xs). This allows you to make it up to your plant before it\'s too late!',
  c3: '',
  c4: '',
  caption3:'Tamagotchi Inspiration',
  caption4:'Plantagotchi supplies',
  problemHeading1:'Designing Plantagotchi',
  problemHeading2:'',
  p1:'While dreaming up Plantagotchi, I imagined a cross between a Tamagotchi (the digital pet from the 90s that was impossible to keep alive), and Anana (an anthropomorphic pineapple from the low-budget 80s Canadian French educational show - Téléfrancais!)',
  p2:'At a most basic level, I understood that my plant needed two things in order to survive: Water, and Light. Accordingly, Plantagotchi has a water sensor and a light sensor. If the plant does not receive light for an extended period of time, or if its water dries up, the Plantagotchi\'s eyes turn to Xs until it receives attention.',
  p3:'When the room is sufficiently light, Plantagotchi\'s eyes move around. When it gets dark it shuts them (see video in Instructables, linked below), as though it is sleeping. The eyes are displayed on two mirrored TFT screens connected to a Teensy Arduino. They are housed in a 3d printed casing, which I\'ve wrapped in electrical tape to prevent water from damaging the components.',
  p4:'',
  p5:'',
  caption5:'Programming the eyes',
  caption6:'3d printed casing',
  resultHeading1: 'First-prize!',
  resultHeading2: '',
  r1:'Plantagotchi won first-prize in the Instructables planter competition. I am currently exploring ways to improve on my original design.',
  r2:'',
  r3:'',
  caption7:'',
  url:"https://www.instructables.com/id/Plantagotchi/",
  urltext:"View the Instructables here.",
},
{id: 2, 
	name: 'Google Summer of Code',
  thumbname: 'Google Summer of Code',
  class: 'hellop5',
  thumbnail:'assets/img/hellop5/hellop5-thumbnail-min.jpg',
  summary:'Interactive web video' ,
  overview: 'A project to modernize the hello.p5js.org website though the development and implementation of a new trailer featuring diverse members of the Processing community. ',
  team: 'Elgin-Skye McLaren, Evelyn Masso (mentor)',
  tags: 'Porcessing Foundation, P5, HTML5 Canvas, Video, Community',
  role: 'Designer, Developer',
  caption1:'Interactive video overlay',
  caption2:'',
  challengeHeading:'Adapting an existing tool for new users.',
  c1:'hello.p5js.org is a website that is designed to be users’ first introduction to p5.js (and possibly Processing as well). The existing website was out of date, and only featured the core p5-creators. They wanted it to be redesigned to feature more members of the community.',
  c2:'',
  c3: '',
  c4: '',
  caption3:'Wordcloud of Survey Responses',
  caption4:'Wireframing',
  problemHeading1:'',
  problemHeading2:'',
  p1:'For this project, I updated the content on hello.p5js.org. The final project is still under review, and will be launched in October. The project involved first, doing qualitative surveys to find out how the community uses p5js. Next, I developed storyboards for the video, and gathered feedback from p5\'s core team. I recruited volunteers, and collected video content. For the website code, I started from scratch, developing new wireframes and interactivty. I edited the video using Adobe Premiere, After Effects, and Audition. The website uses P5.js, and NodeJS. Multi-lingual captions were created to increase accessibility',
  p2:'',
  p3:' ',
  p4:'',
  p5:'',
  caption5:'Screencapture of Interactive Logo',
  caption6:'',
  resultHeading1: '',
  resultHeading2: '',
  r1:'As the individuals viewing the site may be brand new to coding, it is important that this webpage be inviting, interesting and informative. Further, it must be accessible and work properly across devices. I am currently conducting testing to ensure cross-browser compatability. This page will be updated once the project is completed.',
  r2:' ',
  r3:'',
  caption7:'',
 url:"",
...
{id: 3, 
	name: 'Papercraft',
  thumbname: 'Papercraft Lighting',
  class: 'papercraft',
  thumbnail:'assets/img/papercraft/papercraft-thumbnail-min.jpg',
  summary:'Recycled Papercraft Lamps' ,
  overview: 'Personal project to create new designs using found materials',
  team: 'N/A',
  tags: 'Circuits, LEDs, Instructables, Paper Fibres',
  role: 'Designer, Creator',
  caption1:'Petit Prince Lamp',
  caption2:'Petit Prince Supplies',
  challengeHeading:'',
  c1:'I am often inspired to create new objects out of interesting artifacts I find. I particularly enjoy turning found objects and used electronic coponents into lamps based on themes. Recently, one that I created using a found dollar store Hawaiian Lei received an honourable mention in an Instructables contest. I will detail the process of creating this lamp below.',
  c2:'',
  c3: '',
  c4: '',
  caption3:'Project Inspiration',
  caption4:'Soldering Components',
  problemHeading1:'',
  problemHeading2:'',
  p1:'I found a cheap pink Hawaiian Lei that I thought would be fun to do something new with. The color reminded me of the flower from the book the Little Prince. After some brainstorming and prototyping, I decided to create a little mini-planet. I glued a bunch of flowers tightly together to create the rose, and used fibreoptics pulled from a discarded Christmas tree as the stem (creating a neat twinkling effect at the tips). The planet was made from tissue-paper based mache with a battery powered LED circut to light the lamp. The power can be toggled off using a switch at the based of the light.',
  p2:'',
  p3:' ',
  p4:'',
  p5:'',
  caption5:'Lamp in the dark',
  caption6:'Fiberoptics',
  resultHeading1: '',
  resultHeading2: '',

  r1:'As previously mentioned, this project received an honorable mention on Instructables. I continue to make similar work, like the lamp pictured below, and in the header.',
  r2:' ',
  r3:'',
  caption7:'Another Lamp',
 url:"",
  urltext:"",
},
{id: 4, 
	name: 'Podcoasters',
  thumbname: 'Podcoasters',
  class: 'podcoaster',
  thumbnail:'assets/img/podcoaster/podcoaster-thumbnail-min.jpg',
  summary:'NFC Fridge Magnets for Loading Your Favourite Podcasts' ,
  overview: 'Personal project to create tangible objects for collaborative decision making',
  team: 'NA',
  tags: 'NFC, Tangible Computing, Collaboration',
  role: 'Designer, Creator',
  caption1:'Podcoaster Supplies',
  caption2:'',
  challengeHeading:'Finding an easier way to load content',
  c1:'In our house we love listening to podcasts - particularly while working in the kitchen. Trying to decide what to listen to can be a bit challenging though. It can be a bit hard to remember which ones we\'ve listened to most recently, and whether there are any new ones we particularly liked.',
  c2:'To help with our decision making and to make loading podcasts quick and easy, I created Podcoasters - fridge magnet representations of our favourite shows. These tiles are each equipped with an NFC sticker, allowing users to load the corresponding podcast by simply placing their phone near it. ',
  c3: '',
  c4: '',
  caption3:'Podcoaster painting',
  caption4:'',
  problemHeading1:'Designing new interfaces',
  problemHeading2:'',
  p1:'I wanted these to be portable, re-programmable, and visually pleasing. I decided that instead of labeling the tiles, I would paint them with colors corresponding to each podcast. For example. Red & Dark Red match the colour scheme for BBC Global News Podcast. One of the cards is a "wildcard", which we reprogram every few weeks depending on whatever longform podcast we are listening to. We only use a handful so it\'s easy to keep track of them.',
  p2:'I painted the tiles and then added the magnets and NFC stickers. I programmed the NFC stickers using NXP TagWriter.',
  p3:'',
  p4:'',
  p5:'',
  caption5:'Podcoaster in action',
  caption6:'',
  resultHeading1: '',
  resultHeading2: '',

  r1:'This project was a lot of fun to work on and we use these all the time. We prefer them to using a podcast app because it makes collaborative decision making easier - everyone can easily see the podcast list, which facilitates discussion, and we can physically move them based on which ones we\'ve already heard.',
  r2:' ',
  r3:'',
  caption7:'',
  url:"",
...
{ id: 9, 
  ...
  class: 'earthgazing',
  thumbnail:'assets/img/earthgazing/earthgazing-thumbnail-min.jpg',
